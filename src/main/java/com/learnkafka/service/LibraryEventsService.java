...
public class LibraryEventsService {
  ...
  /*
  Записываем в базу данных сообщение
   */
  public void processLibraryEvent(ConsumerRecord<Integer, String> consumerRecord) throws JsonProcessingException {
    LibraryEvent libraryEvent = objectMapper.readValue(consumerRecord.value(), LibraryEvent.class); // получаем объект из json
  ...
  /*
  Отправляет запрос к topic (первый из двух возможных решений логики recovery)
   */
